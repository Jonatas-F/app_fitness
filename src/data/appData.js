...
const baseStats = [
  { label: "Plano ativo", value: "Em montagem", helper: "Pronto para conectar com IA" },
...
function pageData({ badge, title, subtitle, primaryTitle, primaryDescription, primaryItems, asideTitle, asideItems }) {
  return {
    ...
    secondaryCards: [
      {
        title: "Dados que alimentam a IA",
      ...
      },
      {
        ...
        items: ["API de IA", "Tokens", "Treino e dieta"],
      },
    ],
    asideTitle,
    asideItems,
    footerNote: "Dados demonstrativos ate a integracao com backend e IA.",
  };
}
...
export const workoutsViews = {
  list: pageData({
    ...
    primaryDescription: "Nenhum treino gerado pela IA ainda.",
...
export const dietsViews = {
  list: pageData({
    ...
    primaryDescription: "Nenhuma dieta gerada pela IA ainda.",
...
export const progressViews = {
  ...
  bio: pageData({
    ...
    subtitle: "Acompanhe composicao corporal e qualidade dos dados para IA.",
...
export const profileViews = {
  view: pageData({
    ...
    subtitle: "Dados pessoais e preferencias que apoiam check-ins e geracao por IA.",
...
export const chatData = pageData({
  ...
  primaryDescription: "A IA deve consumir tokens conforme o plano do usuario.",
...
export const settingsData = pageData({
  ...
  primaryDescription: "Area preparada para controlar acesso e consumo de IA.",
